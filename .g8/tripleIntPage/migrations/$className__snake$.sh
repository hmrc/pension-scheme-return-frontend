...
echo "$className;format="decap"$.field1.error.required = $field1Label$"  >> ../conf/messages.en
echo "$className;format="decap"$.field1.error.wholeNumber = $field1Label$"  >> ../conf/messages.en
echo "$className;format="decap"$.field1.error.nonNumber = $field1Label$"  >> ../conf/messages.en
echo "$className;format="decap"$.field1.error.max = $field1Label$"  >> ../conf/messages.en
echo "$className;format="decap"$.field2 = $field2Label$"  >> ../conf/messages.en
echo "$className;format="decap"$.field2.error.required = $field2Label$"  >> ../conf/messages.en
echo "$className;format="decap"$.field2.error.wholeNumber = $field2Label$"  >> ../conf/messages.en
echo "$className;format="decap"$.field2.error.nonNumber = $field2Label$"  >> ../conf/messages.en
echo "$className;format="decap"$.field2.error.max = $field2Label$"  >> ../conf/messages.en
echo "$className;format="decap"$.field3 = $field3Label$"  >> ../conf/messages.en
echo "$className;format="decap"$.field3.error.required = $field3Label$"  >> ../conf/messages.en
echo "$className;format="decap"$.field3.error.wholeNumber = $field3Label$"  >> ../conf/messages.en
echo "$className;format="decap"$.field3.error.nonNumber = $field3Label$"  >> ../conf/messages.en
echo "$className;format="decap"$.field3.error.max = $field3Label$"  >> ../conf/messages.en
