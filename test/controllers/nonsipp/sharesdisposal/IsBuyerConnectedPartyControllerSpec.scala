...
class IsBuyerConnectedPartyControllerSpec extends ControllerBaseSpec {
  ...
  private lazy val onPageLoad =
    routes.IsBuyerConnectedPartyController.onPageLoad(srn, shareIndex.value, disposalIndex.value, NormalMode)
  private lazy val onSubmit =
    routes.IsBuyerConnectedPartyController.onSubmit(srn, shareIndex.value, disposalIndex.value, NormalMode)
