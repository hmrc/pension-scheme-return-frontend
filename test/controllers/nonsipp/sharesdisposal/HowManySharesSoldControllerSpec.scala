...
class HowManySharesSoldControllerSpec extends ControllerBaseSpec {
  ...
  private lazy val onPageLoad =
    routes.HowManySharesSoldController.onPageLoad(srn, shareIndex.value, disposalIndex.value, NormalMode)
  private lazy val onSubmit =
    routes.HowManySharesSoldController.onSubmit(srn, shareIndex.value, disposalIndex.value, NormalMode)
