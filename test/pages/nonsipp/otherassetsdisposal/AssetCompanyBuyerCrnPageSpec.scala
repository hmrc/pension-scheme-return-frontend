...
class AssetCompanyBuyerCrnPageSpec extends PageBehaviours {
  ...
  "Asset disposal - AssetCompanyBuyerCrnPage" - {
    ...
    beSettable[ConditionalYesNo[String, Crn]](AssetCompanyBuyerCrnPage(srn, assetIndex, disposalIndex))

    beRemovable[ConditionalYesNo[String, Crn]](AssetCompanyBuyerCrnPage(srn, assetIndex, disposalIndex))
  }
}
