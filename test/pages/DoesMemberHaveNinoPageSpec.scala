...
class DoesMemberHaveNinoPageSpec extends PageBehaviours {
  ...
  "DoesMemberHaveNinoPage" - {
    ...
    beRetrievable[ConditionalYesNo[String, Nino]](DoesMemberHaveNinoPage(srnGen.sample.value, index))

    beSettable[ConditionalYesNo[String, Nino]](DoesMemberHaveNinoPage(srnGen.sample.value, index))

    beRemovable[ConditionalYesNo[String, Nino]](DoesMemberHaveNinoPage(srnGen.sample.value, index))
