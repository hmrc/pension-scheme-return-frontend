    ...
    act.like(
      normalmode
        .navigateToWithIndex(
          ...
          refine[300](controllers.nonsipp.memberreceivedpcls.routes.PclsCYAController.onPageLoad)
        )
    ...
    act.like(
      checkmode
        .navigateTo(
          ...
          (srn, _) =>
            controllers.nonsipp.memberreceivedpcls.routes.PclsCYAController.onPageLoad(srn, index.value, NormalMode)
        )
