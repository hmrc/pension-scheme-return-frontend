...
//
//  override type Pages =
//    PageWithValue[Boolean] :: PageWithValue[SectionCompleted] :: PageWithValue[Boolean] :: PageWithValue[Money] ::
//      PageWithValue[Boolean] :: PageWithValue[Money] :: PageWithValue[LocalDate] :: PageWithValue[SchemeHoldAsset] ::
//      PageWithValue[Boolean] :: PageWithValue[String] :: PageWithValue[Boolean] :: HNil
//}
