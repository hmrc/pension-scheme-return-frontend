...
//
//  override type Pages =
//    PageWithValue[SectionCompleted] :: PageWithValue[Boolean] :: PageWithValue[Boolean] :: PageWithValue[Money] ::
//      PageWithValue[Money] :: PageWithValue[String] :: PageWithValue[Boolean] :: PageWithValue[LocalDate] ::
//      PageWithValue[SchemeHoldBond] :: HNil
//}
