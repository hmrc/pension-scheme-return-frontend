...
//import org.parboiled2.support.hlist.ops.{*, given}
//import org.parboiled2.support.hlist.ops.hlist.given
//import org.parboiled2.support.hlist.syntax.{*, given}
//
//
...
//
//  def addTestData(srn: Srn, num: Int)(using
//    remover: UserAnswersRemover,
//    setter: UserAnswersSetter,
//    ev: Validate[Int, Index]
//  ): Action[AnyContent] =
//    identifyAndRequireData(srn).async { implicit request =>
//      (for {
//        removedUserAnswers <- Future.fromTry(removeAllPages(srn, request.userAnswers)(remover, ev))
...
//    }
//
//  private def removeAllPages(srn: Srn, userAnswers: UserAnswers)(implicit
//    remover: UserAnswersRemover,
//    ev: Validate[Int, Index]
//  ): Try[UserAnswers] =
//    for {
//      indexes <- buildIndexes[Index](max.value)(ev)
...
//  ): Try[UserAnswers] =
//    for {
//      indexes <- buildIndexes[Index](num)(ev)
//      updatedUserAnswers <- indexes.foldLeft(Try(userAnswers)) { case (ua, index) =>
//        pages(srn, index).foldLeft(ua)(SetPages)
//      }
//    } yield updatedUserAnswers
//}
//
...
//
//  def addTestData(srn: Srn, index: Int, num: Int)(implicit
//    remover: UserAnswersRemover,
//    setter: UserAnswersSetter,
//    ev: Validate[Int, Index],
//    ev2: Validate[Int, SecondaryIndex]
//  ): Action[AnyContent] =
//    identifyAndRequireData(srn).async { implicit request =>
//      for {
//        removedUserAnswers <- Future.fromTry(removeAllPages(srn, refineV(index)(ev).toOption.get, request.userAnswers))
//        updatedUserAnswers <- Future.fromTry(
//          updateUserAnswers(num, srn, refineV(index)(ev).toOption.get, removedUserAnswers)
//        )
//        _ <- saveService.save(updatedUserAnswers)
//      } yield Ok(
...
//    }
//
//  private def removeAllPages(srn: Srn, index: RefinedIndex, userAnswers: UserAnswers)(implicit
//    remover: UserAnswersRemover,
//    ev: Validate[Int, SecondaryIndex]
//  ): Try[UserAnswers] =
//    for {
//      indexes <- buildIndexes[SecondaryIndex](max.value)(ev)
//      updatedUserAnswers <- indexes.foldLeft(Try(userAnswers)) { case (ua, disposalIndex) =>
...
//  ): Try[UserAnswers] =
//    for {
//      indexes <- buildIndexes[SecondaryIndex](num)(ev)
//      updatedUserAnswers <- indexes.foldLeft(Try(userAnswers)) { case (ua, secondaryIndex) =>
