...
//
//  override val max: Max5 = 5
//
//  override type Pages =
//    PageWithValue[String] :: PageWithValue[PensionSchemeType] :: PageWithValue[Money] :: PageWithValue[LocalDate] ::
//      PageWithValue[Boolean] :: PageWithValue[SectionCompleted.type] :: HNil
//
