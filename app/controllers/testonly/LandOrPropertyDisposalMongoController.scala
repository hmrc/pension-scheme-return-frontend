...
//
//  override type Pages =
//    PageWithValue[Boolean] :: PageWithValue[RecipientDetails] :: PageWithValue[Boolean] :: PageWithValue[HowDisposed] ::
//      PageWithValue[Boolean] :: PageWithValue[Money] :: PageWithValue[Boolean] :: PageWithValue[IdentityType] ::
//      PageWithValue[LocalDate] :: PageWithValue[SectionCompleted.type] :: HNil
//
