...
//  )
//
//  def viewModel(srn: Srn, mode: Mode, schemeName: String): YesNoPageViewModel = YesNoPageViewModel(
//    SimpleMessage("pensionSchemeMembers.title"),
//    SimpleMessage("pensionSchemeMembers.heading", schemeName),
//    SimpleMessage("pensionSchemeMembers.description"),
//    SimpleMessage("pensionSchemeMembers.description"),
//
//    controllers.routes.PensionSchemeMembersController.onSubmit(srn, mode)
//  )
//}