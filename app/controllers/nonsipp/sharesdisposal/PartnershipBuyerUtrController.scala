        ...
        .fold(
          ...
          value =>
            for {
              ...
              nextPage = navigator.nextPage(PartnershipBuyerUtrPage(srn, index, disposalIndex), mode, updatedAnswers)
  ...
  def viewModel(
    ...
    FormPageViewModel[ConditionalYesNoPageViewModel](
      ...
      ConditionalYesNoPageViewModel(
        yes = YesNoViewModel
          .Conditional(
            Message("sharesDisposal.partnershipBuyerUtr.yes.conditional", partnershipName),
            Some(Message("sharesDisposal.partnershipBuyerUtr.yes.conditional.hint")),
            FieldType.Input
          ),
        no = YesNoViewModel
          .Conditional(
