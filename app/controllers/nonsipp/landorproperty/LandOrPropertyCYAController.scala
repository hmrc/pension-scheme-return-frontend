    ...
    identifyAndRequireData(srn) { implicit request =>
      (
        for {
          ...
          receivedLandType <- requiredPage(PropertyAcquiredFromPage(srn, index))
          recipientName <- List(
  ...
  private def DetailsOfTheAcquisition(
    ...
    val (
      ...
      receivedLandType match {
        case IdentityType.Individual =>
          (
            Message("loanCheckYourAnswers.section3.recipientDetails.nino", recipientName),
            routes.IndividualSellerNiController.onPageLoad(srn, index, mode).url,
            "loanCheckYourAnswers.section3.recipientDetails.nino.hidden",
            "loanCheckYourAnswers.section3.recipientDetails.noNinoReason.hidden"
          )
        case IdentityType.UKCompany =>
          (
            Message("loanCheckYourAnswers.section3.recipientDetails.crn", recipientName),
            controllers.nonsipp.common.routes.CompanyRecipientCrnController
              .onPageLoad(srn, index, mode, IdentitySubject.LandOrPropertySeller)
              .url,
            "loanCheckYourAnswers.section3.recipientDetails.crn.hidden",
            "loanCheckYourAnswers.section1.recipientDetails.noCrnReason.hidden"
          )
        case IdentityType.UKPartnership =>
          (
            Message("loanCheckYourAnswers.section3.recipientDetails.utr", recipientName),
            controllers.nonsipp.common.routes.PartnershipRecipientUtrController
              .onPageLoad(srn, index, mode, IdentitySubject.LandOrPropertySeller)
              .url,
            "loanCheckYourAnswers.section3.recipientDetails.utr.hidden",
            "loanCheckYourAnswers.section3.recipientDetails.noUtrReason.hidden"
          )
        case IdentityType.Other =>
          (
            Message("loanCheckYourAnswers.section3.recipientDetails.other", recipientName),
            controllers.nonsipp.common.routes.OtherRecipientDetailsController
              .onPageLoad(srn, index, mode, IdentitySubject.LandOrPropertySeller)
              .url,
            "loanCheckYourAnswers.section3.recipientDetails.other.hidden",
            ""
          )
      }
    ...
    val (recipientNoDetailsReasonKey, recipientNoDetailsUrl): (Message, String) = receivedLandType match {
      case IdentityType.Individual =>
        Message("loanCheckYourAnswers.section3.recipientDetails.noNinoReason", recipientName) ->
          routes.IndividualSellerNiController.onPageLoad(srn, index, mode).url
      case IdentityType.UKCompany =>
        Message("loanCheckYourAnswers.section3.recipientDetails.noCrnReason", recipientName) ->
          controllers.nonsipp.common.routes.CompanyRecipientCrnController
            .onPageLoad(srn, index, mode, IdentitySubject.LandOrPropertySeller)
            .url
      case IdentityType.UKPartnership =>
        Message("loanCheckYourAnswers.section3.recipientDetails.noUtrReason", recipientName) ->
          controllers.nonsipp.common.routes.PartnershipRecipientUtrController
            .onPageLoad(srn, index, mode, IdentitySubject.LandOrPropertySeller)
            .url
      case IdentityType.Other =>
    ...
    List(
      CheckYourAnswersSection(
        ...
        List(
          CheckYourAnswersRowViewModel(Message("loanCheckYourAnswers.section3.whoReceivedLand", address), receivedLoan)
            .withAction(
              SummaryAction(
                "site.change",
                controllers.nonsipp.common.routes.IdentityTypeController
                  .onPageLoad(srn, index, mode, IdentitySubject.LandOrPropertySeller)
                  .url
              ).withVisuallyHiddenContent("loanCheckYourAnswers.section3.whoReceivedLand.hidden")
            ),
          CheckYourAnswersRowViewModel("loanCheckYourAnswers.section3.recipientName", recipientName)
            .withAction(
              SummaryAction("site.change", recipientNameUrl)
                .withVisuallyHiddenContent("loanCheckYourAnswers.section3.recipientName.hidden")
            )
        ) :?+
