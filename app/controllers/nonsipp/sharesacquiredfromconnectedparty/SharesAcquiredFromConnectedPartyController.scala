...
class SharesAcquiredFromConnectedPartyController @Inject()(
  ...
  private val form = SharesAcquiredFromConnectedPartyController.form(formProvider)
    ...
    form
      ...
      .fold(
        ...
        value =>
          ...
          } yield Redirect(navigator.nextPage(SharesAcquiredFromConnectedPartyPage(srn), mode, updatedAnswers))
      )
  }
}
object SharesAcquiredFromConnectedPartyController {
