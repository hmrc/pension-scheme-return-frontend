...
case class SharesDisposalCompletedPage(srn: Srn, sharesDisposalIndex: Max5000)
    extends QuestionPage[SectionCompleted.type] {

  override def path: JsPath = Paths.disposedSharesTransaction \ toString \ sharesDisposalIndex.arrayIndex.toString
