...
object MemberSurrenderedBenefitsProgress {
  ...
  implicit class SurrenderedBenefitsUserAnswersOps(userAnswers: UserAnswers) {
    ...
    def memberSurrenderedBenefitsProgress(srn: Srn, memberIndex: Max300): Option[SectionJourneyStatus] =
      userAnswers.get(MemberSurrenderedBenefitsProgress(srn, memberIndex))
  }
}
