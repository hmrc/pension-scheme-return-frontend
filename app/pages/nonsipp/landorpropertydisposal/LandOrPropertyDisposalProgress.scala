...
import pages.nonsipp.landorpropertydisposal.Paths.landOrPropertyDisposalProgress
import models.SchemeId.Srn
import play.api.libs.json.JsPath
import viewmodels.models.SectionJourneyStatus

case class LandOrPropertyDisposalProgress(srn: Srn, landOrPropertyIndex: Max5000, disposalIndex: Max50)
    extends QuestionPage[SectionJourneyStatus] {

  override def path: JsPath =
    landOrPropertyDisposalProgress \ landOrPropertyIndex.arrayIndex.toString \ disposalIndex.arrayIndex.toString
}
