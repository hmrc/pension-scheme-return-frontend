...
object SharesDisposalsCheckAnswersSectionUtils extends PsrControllerHelpers {

  def sharesDisposalSections(srn: Srn, shareIndex: Max5000, disposalIndex: Max50, mode: Mode)(using
